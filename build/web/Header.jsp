    ...
    <body>
        <header>
            <div>
                ...
                <ul id="ul1"style=' word-spacing: 30px;'>
                    <li> <img src="ph.png" >ContactVault</li>
                    <li><img src="home.png" ><a href="Home.jsp">Home</a></li>
                    <li><img src="ad.png" ><a href="AddContact.jsp">Add_Contact</a></li>
                    <li><img src="vi.png" ><a href="ViewContact.jsp">View_Contact</a></li>
                    <li><img src="searchicon.png" ><a href="SearchContact.jsp">Search_Contact</a></li>
                    <li><img src="prof.png" ><a href="SearchByCategory.jsp">Search_By_Profession</a></li>
                </ul>
            </div>
        ...
        if(f){
         %>
           <div >
                <ul id="ul2"style='word-spacing: 30px;'>
